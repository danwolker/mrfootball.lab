...
const SidebarFilters: React.FC = () => {
  ...
  return (
    <aside className="sidebar">
      <button
        className="hidden-filter-button display-button"
        onClick={() => toggleDisplay("sidebar-filters")}
      >
      ...
      <div id="sidebar-filters">
        <div>
          <button
            ...
            onClick={() => toggleDisplay("filters-colors")}
          >
            <h2 className="button-title">
              Cores <FaAngleDown />
            </h2>
        ...
        <div>
          <button
            className="display-button"
            onClick={() => toggleDisplay("filters-brands")}
          >
            <h2 className="button-title">
              Marcas <FaAngleDown />
            </h2>
        ...
        <div>
          <button
            className="display-button"
            onClick={() => toggleDisplay("filters-types")}
          >
            <h2 className="button-title">
              Tipos <FaAngleDown />
            </h2>
        ...
        <div>
          <button
            className="display-button"
            onClick={() => toggleDisplay("bootie-type")}
          >
            <h2 className="button-title">
              Botinha <FaAngleDown />
            </h2>
